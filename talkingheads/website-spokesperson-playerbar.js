...
function createPlayer() {
	...
	function createControls() {
		...
		th.controls.playerBar.style.height = th.btn.width + 2 + "px";
		th.controls.playerBar.style.width = th.playerBar.width;
		th.controls.playerBar.style.border = "thin solid " + th.textColor;
		th.controls.playerBar.style.borderRadius = "8px";
		th.controls.playerBar.style.paddingLeft = "3px";
		th.controls.playerBar.style.paddingTop = "1px";
		th.controls.playerBar.style.margin = "auto";
		th.controls.playerBar.style.left = th.playerBar.margin + "px";
