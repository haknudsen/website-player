...
function report() {
	...
	console.log(th.playerBar.marginHeight());
	console.log(th.playerBar.marginBase());
	console.log(th.leftEnd());
	console.log(th.paths.cVideo());
	console.log(th.paths.poster());
}
var th = {
	...
	storage: {
		...
		hasSeen: function () {
			'use strict';
			return "hasSeen-" + this.canvasVideo;
		}
	}
};
/*
